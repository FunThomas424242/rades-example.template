...
- link:#projekteigner[Projekteigner]
...
Dieses Projekt folgt den unter https://piugroup.github.io/rades-example.template/index.html[Verhaltenskodex] abgelegten Verhaltensregeln. Welche auch unter https://www.contributor-covenant.org/de/version/1/4/code-of-conduct/[Verhaltenskodex für Unterstützer] veröffentlicht wurden. 
